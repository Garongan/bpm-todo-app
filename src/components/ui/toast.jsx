...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 z-[100] flex max-h-screen flex-col-reverse pb-4 px-0 md:max-w-[500px]",
      className
    )}
    {...props} />
))
